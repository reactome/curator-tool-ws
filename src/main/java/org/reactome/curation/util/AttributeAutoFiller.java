...
//}
//
//public org.gk.database.AttributeAutoFiller getAttributeAutoFiller(String clsName, String attName) {
//    String target = clsName + "." + attName;
//    String fillerClassName = (String) attributeAutoFillerMap.get(target);
//    if (fillerClassName == null)
//        return null;
//    try {
//        org.gk.database.AttributeAutoFiller filler = (org.gk.database.AttributeAutoFiller) Class.forName(fillerClassName).newInstance();
//        return filler;
//    }
//    catch(Exception e) {
