 ...
 * Note: This class is directly ported from the Curator Tool desktop version since the reactome-base doesn't have:
 * https://github.com/reactome/CuratorTool/blob/master/src/org/gk/property/PMIDXMLInfoFetcher2.java
 * @author gwu
 *
 */
@Component
